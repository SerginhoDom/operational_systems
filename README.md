...
```
Настроить виртуальную машину и вашу программу, созданную в ходе предыдущего задания, таким образом, чтобы при загрузке ОС ваша программа запускалась в монопольном режиме (режиме "Киоска"). Доступ к другим функциям ОС должен быть полностью заблокирован. Программа должна перехватывать ввод со всех устройств ввода и не позволять пользователю закрыть ее и получить доступ к другим программам и функциям ОС.
На проверку: демонстрация работы "киоска".
```
